...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function register(): void
    {
        $validated = $this->validate([
            ...
            'activity_type' => ['required', 'string', 'in:runner,sprinter,hiker,casual_walker,athlete,basketball,fitness,other'],
        ...
        <div class="mt-4">
            ...
            <select
               ...
               focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <option value="casual_walker">Casual Walker</option>
            ...
            <x-input-error
                :messages="$errors->get('activity_type')"
                class="mt-2" />
        </div>
