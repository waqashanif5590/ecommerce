<div class="min-h-screen bg-gray-950 text-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div>
                    ...
                    <a href="{{ route('all.orders') }}"
                        class="inline-flex items-center text-gray-400 hover:text-orange-500 transition-colors mb-3">
            ...
            <div>
                ...
                <p class="text-gray-400 text-sm">
                    ...
                    Order #{{ $order->order_number }} • Placed on {{ $order->created_at->format('F j, Y') }} •
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-gray-800 rounded-lg p-4">
                            ...
                            <p class="text-white font-semibold">
                                {{ $order->estimated_delivery->format('M j, Y') }}
                            </p>
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full {{ $this->isCurrentStatus('pending') ? 'bg-green-500 opacity-20 animate-pulse' : 'bg-gray-700 opacity-0' }}"></div>
                        ...
                        <!-- Timeline Item: Order Processing -->
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full
                                    {{ $this->isCurrentStatus('processed')
                                        ? 'bg-green-500 opacity-20 animate-pulse'
                                        : 'bg-gray-700 opacity-0' }}">
                                </div>

                                <div class="w-12 h-12 rounded-full
                                    {{ $this->isStatusCompleted('processed')
                                        ? 'bg-green-500'
                                        : 'bg-gray-700' }}
                                    flex items-center justify-center border-2 border-gray-600 relative z-10">

                                    <i class="fas fa-{{ $this->isStatusCompleted('processed') ? 'check' : 'clock' }}
                                        text-white text-lg">
                                    </i>
                            ...
                            <div class="pb-8 pt-1">
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <button
                                        type="button"
                                        wire:click="setStatus('processed')"
                                ...
                                <p class="text-gray-400 text-sm mt-1">
                                    {{ $this->getStatusDate('processed') ?? 'Not processed yet' }}
                                </p>
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full
                                    {{ $this->isCurrentStatus('shipped')
                                        ? 'bg-green-500 opacity-20 animate-pulse'
                                        : 'bg-gray-700 opacity-0' }}">
                                </div>

                                <div class="w-12 h-12 rounded-full
                                    {{ $this->isStatusCompleted('shipped')
                                        ? 'bg-green-500'
                                        : 'bg-gray-700' }}
                                    flex items-center justify-center border-2 border-gray-600 relative z-10">

                                    <i class="fas fa-{{ $this->isStatusCompleted('shipped') ? 'check' : 'box' }}
                                        text-white text-lg">
                                    </i>
                            ...
                            <div class="pb-8 pt-1">
                                ...
                                <p class="text-gray-400 text-sm mt-1">
                                    {{ $this->getStatusDate('shipped') ?? 'Not shipped yet' }}
                                </p>

                                <p class="text-gray-600 text-sm mt-2">
                                    Your order will be handed over to the delivery service.
                                </p>
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full
                                    {{ $this->isCurrentStatus('out_for_delivery')
                                        ? 'bg-green-500 opacity-20 animate-pulse'
                                        : 'bg-gray-700 opacity-0' }}">
                                </div>

                                <div class="w-12 h-12 rounded-full
                                    {{ $this->isStatusCompleted('out_for_delivery')
                                        ? 'bg-green-500'
                                        : 'bg-gray-700' }}
                                    border-2 border-gray-600 flex items-center justify-center relative z-10">

                                    <i class="fas fa-{{ $this->isStatusCompleted('out_for_delivery') ? 'check' : 'truck' }}
                                        text-white text-lg">
                                    </i>
                            ...
                            <div class="pb-8 pt-1">
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <button
                                        type="button"
                                        wire:click="setStatus('out_for_delivery')"
                                        wire:loading.attr="disabled"
                                        class="rounded bg-orange-500 px-3 py-1 text-xs font-semibold text-white transition hover:bg-orange-400 disabled:opacity-50">
                                ...
                                <p class="text-gray-400 text-sm mt-1">
                                    {{ $this->getStatusDate('out_for_delivery') ?? 'Not out for delivery yet' }}
                                </p>
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full
                                    {{ $this->isCurrentStatus('delivered')
                                        ? 'bg-green-500 opacity-20 animate-pulse'
                                        : 'bg-gray-700 opacity-0' }}">
                                </div>

                                <div class="w-12 h-12 rounded-full
                                    {{ $this->isStatusCompleted('delivered')
                                        ? 'bg-green-500'
                                        : 'bg-gray-700' }}
                                    border-2 border-gray-600 flex items-center justify-center relative z-10">

                                    <i class="fas fa-{{ $this->isStatusCompleted('delivered') ? 'check' : 'box' }}
                                        text-white text-lg">
                                    </i>
                            ...
                            <div class="pb-8 pt-1">
                                ...
                                <p class="text-gray-400 text-sm mt-1">
                                    {{ $this->getStatusDate('delivered') ?? 'Not delivered yet' }}
                                </p>
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex flex-col items-center pt-1">
                                ...
                                <div class="absolute w-16 h-16 rounded-full
                                    {{ $this->isCurrentStatus('completed')
                                        ? 'bg-green-500 opacity-20 animate-pulse'
                                        : 'bg-gray-700 opacity-0' }}">
                                </div>

                                <div class="w-12 h-12 rounded-full
                                    {{ $this->isStatusCompleted('completed')
                                        ? 'bg-green-500'
                                        : 'bg-gray-700' }}
                                    border-2 border-gray-600 flex items-center justify-center relative z-10">

                                    <i class="fas fa-{{ $this->isStatusCompleted('completed') ? 'check' : 'clock' }}
                                        {{ $this->isStatusCompleted('completed') ? 'text-white' : 'text-gray-400' }}
                                        text-lg">
                                    </i>
                            ...
                            <div class="pb-8 pt-1">
                                ...
                                <p class="text-gray-400 text-sm mt-1">
                                    {{ $this->getStatusDate('completed') ?? 'Not completed yet' }}
                                </p>
                ...
                <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-white font-medium">
                                {{ $order->shipping == 0 ? 'Free' : number_format($order->shipping) }}
                            </span>
                ...
                <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dt class="text-gray-400 text-sm font-medium mb-1">
                                Customer Name
                            </dt>
                ...
                <div class="bg-gray-900 border border-gray-800 rounded-xl p-6">
                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="text-white font-medium text-sm">
                        ...
                        <div>
                            ...
                            <dd class="text-white font-medium">
                                ...
                                {{ $order->payment->paid_at == null
                                    ? 'Pending'
                                    : $order->payment->paid_at->format('F j, Y') }}
        ...
        <div class="mt-12 bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-800 rounded-xl p-8 text-center">
            ...
            <h2 class="text-2xl font-semibold text-white mt-4 mb-3">
            ...
            <button
                class="inline-block px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition-colors duration-200">
